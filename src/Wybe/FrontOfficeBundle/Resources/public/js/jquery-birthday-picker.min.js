$(function(e) {
    ...
    generateBirthdayPicker = function(n, s) {
        var o = e("<fieldset class='birthdayPicker'></fieldset>"),
            ...
            f = e("<select class='form-control birthDate " + s.sizeClass + "' name='birth[day]'></select>");
        $birthday = e("<input class='birthDay' name='birthDay' type='hidden'/>");
        if (s.placeholder) {
            e("<option value='0'>Année</option>").appendTo(u);
            e("<option value='0'>Mois</option>").appendTo(a);
            e("<option value='0'>Jour</option>").appendTo(f)
        }
