...
function newPostWithEvent(){
    $("#generic-new-post-with-event").on("submit", function(e){
    e.preventDefault();
    ...
    $.ajax({ 
        ...
        // attach gallery to post
        var postAttachmentHTML = document.createElement('div');
        postAttachmentHTML.innerHTML = data.postAttachmentView;
        li.querySelector(".generic-blog-post-content").appendChild(postAttachmentHTML);
